...
/* A module containing useful services for OpenSLAT. */
var MOD_services = angular.module('app.services', []);

/*******************************************************************************
 * inputService handles the JSON model of the user's input. As fields on the
 * page are edited, inputService maintains an internal model of all the data.
 * It also handles sending a request to the server when the user wishes to
 * calculate something.
 *
 * The inputJson variable in this file contains sample data for testing.
 * This data should be removed before being put into production.
 ******************************************************************************/
...
/*******************************************************************************
 * The jsonConverter service acts as an adapter between the client and server
 * JSON models. If the server model changes, this function should be changed to
 * adapt it to the client format.
 ******************************************************************************/
MOD_services.factory('jsonConverter', function() {
	return {
...
/*******************************************************************************
 * The textParser service handles the parsing of CSV files.
 ******************************************************************************/
MOD_services.factory('textParser', function() {
	return {
...
/*******************************************************************************
 * The distService handles the generation of normal and lognormal cumulative
 * distributions.
 ******************************************************************************/
MOD_services.factory('distService', function() {
...
/*******************************************************************************
 * The colorService handles the generation of unique colors for line charts.
 ******************************************************************************/
MOD_services.factory('colorService', function() {
	return {
...
/*******************************************************************************
 * The pathService handles the extraction of filenames from paths.
 ******************************************************************************/
MOD_services.factory('pathService', function() {
	return {
